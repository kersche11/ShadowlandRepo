...
public class BossChasingRunState : BossBaseState
{
    ...
    public BossChasingRunState(BossStateMachine stateMachine) : base(stateMachine){}
    ...
    public override void Tick(float deltaTime)
    {
        ...
        {
            Debug.Log("Attack");
            stateMachine.SwitchState(new BossAttackingState(stateMachine));
            return;
        }
